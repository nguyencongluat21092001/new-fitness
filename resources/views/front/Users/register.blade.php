                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Fitness_LifeStyle!</h1>
                            </div>
                            <form action="{{ route('store.users') }}" class="user" method="POST">
                                @method("POST")
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="text" name="post_email"class="form-control form-control-user" id="exampleInputEmail"
